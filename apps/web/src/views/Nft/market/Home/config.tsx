  ...
  return [
    {
      ...
      description: [
        t(
          'Trades are settled in WBNB, which is a wrapped version of BNB used on BBC Butane Testnet. That means that when you sell an item, WBNB is sent to your wallet instead of BNB.',
        ),
