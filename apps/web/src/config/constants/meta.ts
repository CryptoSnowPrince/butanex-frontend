...
//   title: 'Butanex',
//   description:
//     'The most popular AMM on BBC Butane Chain by user count! Earn Butanex through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by Butanex), NFTs, and more, on a platform you can trust.',
